      ...
      <ScrollView vertical={true} showsVerticalScrollIndicator={false}>
        ...
        <View className="px-3 py-3 mt-2 mb-3 text-justify text-gray-800">
          <Text className="text-base font-semibold ">
            ...
            {"\n"}
            {"\n"}තොග ප්‍රවාහය: පීඩන අනුක්‍රමණයක් ඔස්සේ ද්‍රව හා ද්‍රව්‍ය අංශුද
            සමඟ ගමන් කිරීම තොග ප්‍රවාහයයි.සැමවිටම පීඩනය වැඩි ස්ථානයක සිට පීඩනය
            අඩු ස්ථානයකට ද්‍රව්‍ය පරිවහනය වේ.මෙය දිග දුරකට ද්‍රව්‍ය පරිවහනය වන
            ක්‍රමයකි.මෙයපටලයක් හරහා සිදු නොවේ. මේ පරිවහනය විසරණය ට වඩා වැඩි
            වේගයෙන් සිදුවේ.මෙය සාන්ද්‍රණ අනුක්‍රමයෙන් ස්වාධීනව සිදුවේ.
          </Text>
        </View>
        {/* Lesson Note End */}
